...
[Ollama][04], a CLI tool for managing and using locally built LLM/SLMs. The complete source code of
the agent can be found in the `shell/agents/AIShell.Ollama.Agent` folder of the repository. the
repository.
...
[01]: https://github.com/PowerShell/ProjectMercury/shell/shell.common.props
[02]: https://github.com/PowerShell/ProjectMercury/shell/agents/AIShell.Ollama.Agent
[03]: https://github.com/PowerShell/ProjectMercury/shell/README.md
